...
(function (layui, window, factory) {
    ...
    var v = '4.0.0.0910',
        ...
        quickBtns = [{
            ...
            icon: 'xm-iconfont icon-qingkong', name: $.i18n.prop("Clear"), click: function click(id, cm) {
