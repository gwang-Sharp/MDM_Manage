    ...
    methods: {
        ...
        handleDelete: function (index, row) {
            ...
            that.$confirm('此操作将将删除该属性, 是否继续?', '提示', {
                ...
                $.post("/system/AttributeDel", { Id: id }, RES => {
                    //console.log(RES);
                    if (RES.success) {
                        that.$message({
                            message: RES.message,
                        ...
                        if (that.pagination.currentpage > 1 && !RES.data) {
                            that.pagination.currentpage = 1;
                            that.InitUserTable(that.AttributesRuleForm.EntityID || 0);
                        }
        ...
        handleEdit: function (index, row) {
            ...
            this.$nextTick(() => {
                ...
                this.AttributesRuleForm.StartTrace = row.startTrace == "是" ? true : false;
            ...
            ModelVM.$refs.AttributesRuleForm.validate((valid) => {
                if (valid) {
                    ...
                    if (that.AttributesRuleForm.StartTrace) {
                        that.AttributesRuleForm.StartTrace = "是";
                    }
                    else {
                        that.AttributesRuleForm.StartTrace = "否";
                    }
